...
public final class  FilenameMatch {
    ...
    */
    ...
    /*
     Se true, lista arquivos pela ordem lexografica dos nomes
     default : true
     */
    ...
    */
    ...
    private static void readInputs(final String charset) throws IOException, UnsupportedEncodingException {
       ...
       //Define se a lista de arquivos que deram match com substrings sera
       //exibida em ordem lexigrafica-------------------------------------------
       
        inputReader.setPrompt(
            "Ordenar lexograficamente a sa\u00edda",
            true
        );
        
        order = inputReader.readInput().equals("s"); 
        
       //Define se o programa fara ou nao uma pesquisa exaustiva por substrings
       //coincidentes entre nomes de arquivos.
       
        inputReader.setPrompt(
            "Pesquisa em curto-circuito",
            true
        );
        
        shortSearch = inputReader.readInput().equals("s"); 
        
        //Define se o conteudo dos arquivos que dao match serao ou nao
        //comparados para ver se sao iguais. 
        
        inputReader.setPrompt(
            "Compara arquivos que deram match para ver se s\u00e3o iguais",
            false
        );
...
==============================================================================*/    
private final static class MatchLengthParser extends InputParser {
...
private final static class MinimumTokenLengthParser extends InputParser {
...
private final static class OutputFilenameParser extends InputParser {
...
private final static class FilenameFilterRegexParser extends InputParser {
...
private final static class FileExtensionsParser extends InputParser {
...
private final static class FilesFilter implements FileFilter {
    ...
    public boolean accept(File file) {
        ...
        if (isDir && !searchSubdirs) return false; 
